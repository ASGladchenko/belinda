...
export const setClass = (variant: IVariant) => {
  return clsx(
    ...
    {
      'enabled:text-black enabled:dark:text-white bg-admin-primary border-admin-primary enabled:hover:bg-admin-primaryHover enabled:active:bg-admin-primaryActive':
        variant === 'primary',
